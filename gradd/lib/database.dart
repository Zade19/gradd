...
class Back4app
{
  ...
  {//connect to our parse server running on back4app
  ...
  static Future<void> installation(String token) async
  {
    //create an installation object for this device and adn join the group all
